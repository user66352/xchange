        ...
        void conn_loop()
        {
            ...
            while(connected)
            {
                switch (state)
                {
                    ...
                    {
                        #ifdef DEBUG
                        std::cout << "DEBUG::ProtocolHandler_ChaCha20::STATE_GET_TYPE" << std::endl;
                        #endif
                    ...
                    {
                        #ifdef DEBUG
                        std::cout << "DEBUG::ProtocolHandler_ChaCha20::STATE_CHACHA20_GET_IV" << std::endl;
                        #endif
                    ...
                    {
                        #ifdef DEBUG
                        std::cout << "DEBUG::ProtocolHandler_ChaCha20::STATE_CHACHA20_READ_KEY_FILE" << std::endl;
                        #endif
                    ...
                    {
                        #ifdef DEBUG
                        std::cout << "DEBUG::ProtocolHandler_ChaCha20::STATE_ACCEPT_CONNECTION" << std::endl;
                        #endif
                    ...
                    {
                        #ifdef DEBUG
                        std::cout << "DEBUG::ProtocolHandler_ChaCha20::STATE_RCV_DATA" << std::endl;
                        #endif
                    ...
                    {
                        #ifdef DEBUG
                        std::cout << "DEBUG::ProtocolHandler_ChaCha20::STATE_FINAL_ACK" << std::endl;
                        #endif
                    ...
                    {
                        #ifdef DEBUG
                        std::cout << "DEBUG::ProtocolHandler_ChaCha20::STATE_PM_CLOSE_CONN" << std::endl;
                        #endif
